        ...
        <div class="pwell">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-2 pointer" style="color:#337ab7;" data-target='#addNewAdminModal' data-toggle='modal'><button class="btn btn-primary btn-sm"><i class="fa fa-user-plus">&nbsp;<span style="font-family: monospace;">New Employee</span></i></button>
                    </div>
