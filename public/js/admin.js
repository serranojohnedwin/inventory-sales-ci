...
$(document).ready(function(){
    ...
    $("#addAdminSubmit").click(function(e){
        ...
        $.ajax({
            ...
            if(returnedData.status === 1){
                $("#fMsg").css('color', 'green').text('Employee account successfully created!');
    ...
    $("#editAdminSubmit").click(function(e){
        ...
        if(formChanges("editAdminForm")){
            ...
            $("#fMsgEdit").text(" Email Already Exists...");
            ...
            $.ajax({
                ...
                if(returnedData.status === 1){
                    ...
                    if(!navigator.onLine){
                        $("#fMsgEdit").css('color', 'red').html("Network error! Please check your network connection.");
                    }
                });
        }
